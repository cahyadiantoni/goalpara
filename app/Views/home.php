...
<div class="HomeDefault" style="width: 100%; height: 1024px; position: relative; background: white">
  ...
  <div class="Group2" style="left: 165px; top: 70px; position: absolute">
    ...
    <div class="Administrator" style="left: 89px; top: 18px; position: absolute; color: white; font-size: 22px; font-family: Poppins; font-weight: 600; word-wrap: break-word"> <?= $name ?> </div>
  </div>
